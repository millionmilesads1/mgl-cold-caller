...
const OPENERS = [
  '"Hi, is this the owner of [BUSINESS]? Hey, this is Hitesh. I will be real with you, this is a cold call. You can hang up or give me 20 seconds. What do you say?"',
  '"Hi, am I speaking with someone at [BUSINESS]? This is Hitesh. I know nobody likes surprise calls. 20 seconds and if I waste your time I will disappear. Fair?"',
  '"Hi, is this [BUSINESS]? This is Hitesh. Before you hang up, not selling insurance, not about your car warranty. I actually looked at your company online and have a quick question. 20 seconds?"',
];
const HOOKS = [
  'So I was looking at roofing companies in [CITY] and I pulled up your online presence. Honestly, some of your competitors in the area have websites that look way more professional and trustworthy. I am not saying they do better work. But if I was a homeowner choosing between you and them just based on what I see online, I would probably call them first.',
  'I was researching roofing companies in [CITY] and found [BUSINESS]. You clearly know your craft. But your online presence does not match the quality of work you do. When homeowners Google roofers in [CITY], the companies with clean modern websites get the calls. The rest get skipped.',
  'Quick question. When a homeowner in [CITY] needs a roofer and Googles it, what do they see when they find [BUSINESS] online? Because right now your competitors are showing up with sharp websites, reviews front and center, click to call buttons. If your site does not match that, you are losing jobs to guys who might not even be as good as you.',
];
const ASK = 'Here is what I would like to do. I will put together a quick side by side showing how [BUSINESS] looks online versus your top competitors in [CITY]. No charge, no strings. Takes me 20 minutes. I send it over and you tell me if it is worth a 10 minute chat. Sound fair?';
const CLOSE = 'Great. I will have that over to you by [DAY]. Look for an email from Hitesh at MGL. What is the best email to send it to? ... Perfect. Appreciate your time, talk soon.';
const OBJECTIONS = [
  ["I already have a website", 'That is great. Quick question though, when was the last time the design was actually updated? Not the text, the actual look and feel. Because what looked professional 3 years ago looks dated today. Homeowners notice. Let me show you what I mean, takes 2 minutes.'],
  ["I get all my work from referrals", 'That is a great sign, means your work speaks for itself. But here is the thing. Even referral customers Google you before they call. If your online presence looks outdated, some of them are calling your competitor instead. A strong website protects your referral pipeline.'],
  ["Not interested", 'Totally fair. One thing before I go. If I could send you a single screenshot showing exactly how your online presence stacks up against the top roofer in [CITY], would that be worth looking at? Just one image, 10 seconds of your time.'],
  ["How much does that cost?", 'Depends on what you need, but most roofing companies I work with are in the $2,500 to $5,000 range. But honestly, let me show you the gap first. If the value is not obvious, the price does not matter anyway.'],
  ["Send me an email", 'Happy to. I will send you one screenshot, your online presence versus the top competitor in [CITY]. If it grabs your attention, reply. If not, no hard feelings. What is the best email?'],
  ["I am too busy right now", 'Totally respect that, you are out there on roofs not sitting at a desk. When is better for a 2 minute call? Early morning before you head out, or end of day? I will keep it short, I promise.'],
  ["I had a bad experience with a web guy", 'I hear that a lot honestly. Most web designers build something pretty and disappear. I work specifically with roofing companies so I know what actually drives calls, not just what looks nice. The audit I am offering is free, so worst case you get useful info with zero risk.'],
];
const DISPS = [
            ...
            {sel && <div style={{ flex: "1 1 350px" }}>
              <div style={{ background: c.card, border: `1px solid ${c.acc}33`, borderRadius: 8, padding: 14 }}>
                ...
                {sel.call_history?.length > 0 && <div style={{ marginTop: 10, borderTop: `1px solid ${c.bd}`, paddingTop: 8 }}>
                  ...
                  {[...sel.call_history].reverse().slice(0, 5).map((ch, i) => {
                    const dd = DISPS.find((x) => x.id === ch.disposition); return (
